...
# Lista com as 30 figurinhas, deixando ativas apenas as que existem na pasta
# (ID 30 não possui imagem correspondente e foi comentada)
figurinhas = [
...
# Crie o endpoint GET "/figuras" e "/figurinhas" que retorna a lista
@app.get("/figuras")
@app.get("/figurinhas")
def listar_figuras():
    return figurinhas

# Crie o endpoint GET "/figurinhas/{id}/imagem" para obter a imagem por ID
